...
* http://projects.spring.io/spring-boot/[Spring Boot 1.4.3]
...
=== v1.1 (BE in progress, Angular 2 FE is old and will be totally rewritten in v1.2)
...
- Task #1.1.7 (70%) create client service and client controller
- Task #1.1.8 (70%) create role service and role controller
...
- Task #1.1.11 (60%) add Oval validation for entities

=== v1.2
- initial React.js configuration
