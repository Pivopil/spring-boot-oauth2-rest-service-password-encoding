...
import io.github.pivopil.share.persistence.ws.WebSocketDisconnectHandler;
...
//@Configuration
//@EnableWebSocket
public class WebSocketConfiguration {//<S extends ExpiringSession> implements WebSocketConfigurer {
